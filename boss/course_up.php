...
$query = $con->selectdb('SELECT * FROM tbl_course_category');
...
$sqlC=$con->selectdb("SELECT cat_id FROM tbl_course where course_id=".$course_id."");
                ...
                function generate_menu($parent)
                {
                        ...
                        foreach($menuItems as $key => $value)
                        {
                            ...
                            {    
                                ...
                                {
                                    echo '<li data-jstree='.'{"opened":true}'.'><a href="coursecategory.php?id=' . $key . '">' . $value['cat_name'] . '<b class="caret"></b></a>';
                                }
                                else if($value['cat_parent_id'] != 0 && in_array($key, $parentMenuIds))
                                {
                                    echo '<li data-jstree='.'{"opened":true}'.'><a href="coursecategory.php?id=' . $key . '">' . $value['cat_name'] . '</a>';
                                }
                                else
                                {
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Courses Form</h4>
                                <form class="form-horizontal" method="post" action="course_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    {
                                    ?>
                                    <input type="hidden" name="course_id" id="course_id" value="<?php echo $row[0]; ?>" />	
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="course_title" name="course_title" placeholder="Name" value="<? echo $row[2];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[1]!=''){echo "../course/".$row[1];}?>"/>
                                            <? if($row[1]!=''){?>
                                                <a href="course_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
