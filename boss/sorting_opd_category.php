    ...
    $(document).ready(function(){ 
        ...
        $(function() {
            $(".sortable").sortable({ opacity: 0.6, cursor: 'move', update: function() {
                ...
                $.post("update_opd_category.php", order, function(theResponse){
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <h4 class="mt-0 header-title">OPD Category List</h4>
                            <div class="card-box">
                            <div class="sortable">
                                <?php
								$query  = "SELECT * FROM tbl_opd_category ORDER BY recordListingID ASC";
