...
{	    
    ...
    $con->insertdb("INSERT INTO `tbl_doctorawards` (`doctorawards_title`, `description`,`meta_tag_title`, `meta_tag_description`, `meta_tag_keywords`, `slug`) VALUES ('".$service_title."', '".$description."', '".$meta_tag_title."', '".$meta_tag_description."', '".$meta_tag_keywords."', '".$slug."');");
        
        
    
    header("location:doctorawardsView.php");
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Doctor Award</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 mb-2 header-title">Doctor Award Form</h4>
