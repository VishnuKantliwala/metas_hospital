...
$query = $cn->selectdb('SELECT * FROM tbl_programme_category');
                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="programme_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="programme_title" name="programme_title" placeholder="Name">
                                        </div>
                                    </div>						
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea type="text" class="ckeditor" id="caption" name="caption" placeholder="Caption"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Image (35 : 27)</label>
                                        <div class="col-sm-4">
