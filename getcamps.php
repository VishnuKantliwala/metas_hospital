...
$sql1 = $cn->selectdb("select camp_title, slug, caption, image_name from tbl_camp  order by recordListingID ASC LIMIT $limit OFFSET $offset");
    ...
    <div class="row " style="background: #eee; padding:10px">
        ...
        <div class="col-md-12 col-xs-12 col-sm-6">
            <div class="blog_image pt-10" style="    margin-bottom: 10px;">
                <img class="health-camp-img bb-3" src="camp/big_img/<?echo $image_name?>" alt="<?echo $camp_title?>" style="   border-radius:  30px 0px ;">
            </div>
        ...
        <div class="col-md-12 col-xs-12 col-sm-6 blog_post">
            ...
            <div class="blog_title">
                <a href="<?echo $href?>">
                    <h4 class="list-title list-title--camp-title color-link"><?echo $camp_title ?></h4>
                </a>
            </div>
