...
$query = $con->selectdb('SELECT * FROM tbl_doctor_category');
...
$sqlC=$con->selectdb("SELECT cat_id FROM tbl_doctor where doctor_id=".$doctor_id."");
    ...
    function generate_menu($parent)
    {
            ...
            foreach($menuItems as $key => $value)
            {
                ...
                {    
                    ...
                    {
                        echo '<li data-jstree='.'{"opened":true}'.'><a href="doctorcategory.php?id=' . $key . '">' . $value['cat_name'] . '<b class="caret"></b></a>';
                    }
                    else if($value['cat_parent_id'] != 0 && in_array($key, $parentMenuIds))
                    {
                        echo '<li data-jstree='.'{"opened":true}'.'><a href="doctorcategory.php?id=' . $key . '">' . $value['cat_name'] . '</a>';
                    }
                    else
                    {
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">doctor</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">doctor Form</h4>
                                
                                <form class="form-horizontal" method="post" action="doctor_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    <input type="hidden" name="page" id="page" value="<? echo isset($_GET['page']);?>">

                                    <?php
                                    $records=$cn->selectdb("SELECT * FROM tbl_doctor where doctor_id=".$doctor_id."");
                                    while($row=mysqli_fetch_array($records))
                                    {
                                    ?>
                                    <input type="hidden" name="doctor_id" id="doctor_id" value="<?php echo $row[0]; ?>" />
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">doctor Name</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="doctor_name" name="doctor_name" value="<?php echo $row[1]; ?>" placeholder="doctor Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-12 control-label">Image (17 : 20)</label>
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" data-default-file="<?if($row[4]!=''){echo '../doctor/'.$row[4];}?>" class="dropify"/>
                                            <? if($row[4]!=''){?>
                                            <a href="doctor_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                                                ...
                                                                <li class="list-inline-item file-box">
                                                                    <div class=" custom-control custom-switch">
                                                                        ...
                                                                        <label class="custom-control-label" for="<?php echo $image_list[$i]; ?>">
                                                                            <img src="../doctorF/<?php echo $image_list[$i]; ?>" class="img-fluid img-thumbnail" alt="attached-img" width="80">
                                                                        </label>
                                                                    </div>
                                                                </li>
                                                    <?php
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="doctor_instagram" name="doctor_instagram" placeholder="Instagram Link" value="<?php echo $row['doctor_instagram']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="doctor_twitter" name="doctor_twitter" placeholder="Instagram Link" value="<?php echo $row['doctor_twitter']?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="doctor_facebook" name="doctor_facebook" placeholder="Facebook Link" value="<?php echo $row['doctor_facebook']?>">
                                        </div>
                                    </div>

                                    <div class="form-group"  style="display:none">
                                        <label for="inputEmail3" class="col-sm-12 control-label">doctor Video</label>
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="doctor_video" name="doctor_video" placeholder="Embeded code of the video"><?php echo $row[16]?></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" name="updateDoctor" id="updateDoctor" class="btn btn-success">Update</button>
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='doctorView.php'; return false;">Cancel</button>
                                        </div>
                                    </div>
