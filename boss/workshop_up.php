...
$query = $con->selectdb('SELECT * FROM tbl_workshop_category');
...
$sqlC=$con->selectdb("SELECT cat_id FROM tbl_workshop where workshop_id=".$workshop_id."");
                ...
                function generate_menu($parent)
                {
                        ...
                        foreach($menuItems as $key => $value)
                        {
                            ...
                            {    
                                ...
                                {
                                    echo '<li data-jstree='.'{"opened":true}'.'><a href="workshopcategory.php?id=' . $key . '">' . $value['cat_name'] . '<b class="caret"></b></a>';
                                }
                                else if($value['cat_parent_id'] != 0 && in_array($key, $parentMenuIds))
                                {
                                    echo '<li data-jstree='.'{"opened":true}'.'><a href="workshopcategory.php?id=' . $key . '">' . $value['cat_name'] . '</a>';
                                }
                                else
                                {
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Workshop</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Workshop Form</h4>
                                <form class="form-horizontal" method="post" action="workshop_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    <input type="hidden" name="page" id="page" value="<? echo isset($_GET['page']);?>">
                                    
                                    <?php
                                    $records=$con->selectdb("SELECT * FROM tbl_workshop where workshop_id=".$workshop_id."");
                                    while($row=mysqli_fetch_array($records))
                                    {
                                    ?>
                                    <input type="hidden" name="workshop_id" id="workshop_id" value="<?php echo $row[0]; ?>" />	
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="workshop_title" name="workshop_title" placeholder="Name" value="<? echo $row[2];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" id="workshop_date" name="workshop_date" placeholder="Date" value="<? echo $row['workshop_date'];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[1]!=''){echo "../workshop/".$row[1];}?>"/>
                                            <? if($row[1]!=''){?>
                                                <a href="workshop_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-12">
                                            ...
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='workshopView.php'; return false;" >Cancel</button>
                                        </div>
                                    </div>
