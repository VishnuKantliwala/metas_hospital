...
$sql1 = $cn->selectdb("select rally_title, slug, description, image_name from tbl_rally  order by recordListingID ASC LIMIT $limit OFFSET $offset");
    ...
    <div class="row " style="background: #eee; padding:10px">
        ...
        <div class="col-md-9 col-xs-12 col-sm-6 blog_post">
            ...
            <div class="blog_title">
                <a href="<?echo $href?>">
                    <h4 style="line-height: 40px;"><?echo $rally_title ?></h4>
                </a>
            </div>
