...
$doctorawards_id=$_GET['doctorawards_id'];
...
if(isset($_POST['updateSlider']))
{
            ...
            $con->insertdb("UPDATE `tbl_doctorawards` SET `doctorawards_title` = '".$service_title."', `description` = '".$description."', meta_tag_title='".$meta_tag_title."',meta_tag_description='".$meta_tag_description."',meta_tag_keywords='".$meta_tag_keywords."',slug='".$slug."' WHERE `tbl_doctorawards`.`doctorawards_id` = '".$doctorawards_id."'");
...
if(isset($_GET["Image"]))
	...
	$page=$_GET['page'];
	$doctorawards_id= $_GET['doctorawards_id'];
	$records=$con->selectdb("SELECT * FROM tbl_doctorawards where doctorawards_id=".$doctorawards_id."");
	while($row=mysqli_fetch_row($records))
	{
	  unlink('../doctorawards/'.$row[1]);
	  unlink('../doctorawards/big_img/'.$row[1]);

	}
	$con->selectdb("update tbl_doctorawards set image_name='' where doctorawards_id = '".$doctorawards_id."'");
	header("location: doctorawardsUpdate.php?doctorawards_id=".$doctorawards_id."&page=".$page);
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Doctor awards</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 mb-2 header-title">Doctor awards Form</h4>
                                <form class="form-horizontal" method="post" action="#" id="myform" name="myform" enctype="multipart/form-data">
									 ...
									 <?php
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="service_title" name="service_title" placeholder="Name" value="<? echo $row['doctorawards_title']; ?>">
                                            </div>
                                        </div>	
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                ...
                                                <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='doctorawardsView.php'; return false;" >Cancel</button>	
                                            </div>
                                        </div>
