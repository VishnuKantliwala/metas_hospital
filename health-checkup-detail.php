<?
$page_id = 17;
$camp_id = urldecode($_GET['camp_id']);


include_once("header.php");
$sqlHandw = $cn->selectdb("select * from tbl_camp where slug = '".$camp_id."' ");
        ...
        <div class="row">
                ...
                <div class="single_blog_contents reveal animated" data-reveal-anim="fadeInUpShort">
                    <div class="single_blog_header">
                        <div class="single_blog_img">
                            <img src="camp/big_img/<?echo $image_name?>" alt="<?echo $camp_title?>">
                        </div>
            ...
            <div class="col-md-4 col-sm-4 col-md-offset-0">
                            ...
                            <li>
                                <div class="single_portfoilo_item">
                                    ...
                                    <div class="portfolio_image">
                                        <img src="<?echo $src?>" alt="<?echo $camp_title?>" class="gallery_cat_img">
                                    </div>
                                </div>
                            </li>
                ...
                <div class="widget reveal animated" data-reveal-anim="fadeInLeft" style="<? echo $style ?>">
                    <div class="widget_heading">
                        <h4>Health Checkup Camps</h4>
                    </div>
                    <div class="catagory_list">
                        <ul>
                            <?
                                
                            $sqlServices = $cn->selectdb("SELECT camp_title, slug from tbl_camp  order by camp_title");
                            if( $cn->numRows($sqlServices) > 0 )
                            {
                                while($rowServices = $cn->fetchAssoc($sqlServices))
                                {
                                    extract($rowServices);
                                    $href = "health-checkup-camps/".urlencode($slug);
                            ?>
                            <li <? if($slug==$camp_id) {?> class="list-active"
                                <?}?> ><a href="<?echo $href?>">
                                    <?echo $camp_title ?></a></li>
                            <?
                                }
                            }
                            ?>
