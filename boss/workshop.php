...
$query = $cn->selectdb('SELECT * FROM tbl_workshop_category');
                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="workshop_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="workshop_title" name="workshop_title" placeholder="Name">
                                        </div>
                                    </div>	
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" id="workshop_date" name="workshop_date" placeholder="Date">
                                        </div>
                                    </div>	
