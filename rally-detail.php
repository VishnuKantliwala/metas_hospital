...
$sqlHandw = $cn->selectdb("select * from tbl_rally where slug = '".$rid."' ");
                ...
                <div class="single_blog_contents reveal animated" data-reveal-anim="fadeInUpShort">
                    <div class="single_blog_header">
                        <div class="single_blog_img">
                            <img src="rally/big_img/<?echo $image_name?>" alt="<?echo $rally_title?>">
                        </div>
                            ...
                            <li>
                                <div class="single_portfoilo_item">
                                    ...
                                    <div class="portfolio_image">
                                        <img src="<?echo $src?>" alt="<?echo $rally_title?>" class="gallery_cat_img">
                                    </div>
                                </div>
                            </li>
                ...
                <div class="widget reveal animated" data-reveal-anim="fadeInLeft" style="<? echo $style ?>">
                    ...
                    <div class="catagory_list">
                        <ul>
                            ...
                            $sqlServices = $cn->selectdb("SELECT rally_title, slug from tbl_rally  order by rally_title");
                            if( $cn->numRows($sqlServices) > 0 )
                            {
                                while($rowServices = $cn->fetchAssoc($sqlServices))
                                {
                                    extract($rowServices);
                                    $href = "rallies/".urlencode($slug);
                            ?>
                            <li <? if($slug==$rid) {?> class="list-active"
                                <?}?> ><a href="<?echo $href?>">
                                    <?echo $rally_title ?></a></li>
                            <?
                                }
                            }
                            ?>
