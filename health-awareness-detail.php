<?
$page_id = 34;
$programme_id = urldecode($_GET['programme_id']);


include_once("header.php");
$sqlHandw = $cn->selectdb("select * from tbl_programme where slug = '".$programme_id."' ");
        ...
        <div class="row">
                ...
                <div class="single_blog_contents reveal animated" data-reveal-anim="fadeInUpShort">
                    <div class="single_blog_header">
                        <div class="single_blog_img">
                            <img src="programme/big_img/<?echo $image_name?>" alt="<?echo $programme_title?>">
                        </div>
            ...
            <div class="col-md-4 col-sm-4 col-md-offset-0">
                            ...
                            <li>
                                <div class="single_portfoilo_item">
                                    ...
                                    <div class="portfolio_image">
                                        <img src="<?echo $src?>" alt="<?echo $programme_title?>" class="gallery_cat_img">
                                    </div>
                                </div>
                            </li>
                ...
                <div class="widget reveal animated" data-reveal-anim="fadeInLeft" style="<? echo $style ?>">
                    <div class="widget_heading">
                        <h4>Health Awareness Programme</h4>
                    </div>
                    <div class="catagory_list">
                        <ul>
                            <?
                                
                            $sqlServices = $cn->selectdb("SELECT programme_title, slug from tbl_programme  order by programme_title");
                            ...
                            ?>
                            <li <? if($slug==$programme_id) {?> class="list-active"
                                <?}?> ><a href="<?echo $href?>">
                                    <?echo $programme_title ?></a></li>
                            <?
                                }
                            }
                            ?>
