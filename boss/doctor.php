...
$query = $cn->selectdb('SELECT * FROM tbl_doctor_category');
                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="doctor_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" style="display:none">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Doctor Video</label>
                                        <div class="col-sm-12">
                                            <textarea cols="5" rows="5" class="form-control" id="doctor_video" name="doctor_video" placeholder="Embeded code of the video"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="doctor_instagram" name="doctor_instagram" placeholder="Instagram Link">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="doctor_twitter" name="doctor_twitter" placeholder="Instagram Link">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="doctor_facebook" name="doctor_facebook" placeholder="Facebook Link">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" name="addDoctor" id="addDoctor" class="btn btn-success">Add</button>
