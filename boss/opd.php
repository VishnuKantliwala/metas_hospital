...
$query = $cn->selectdb('SELECT * FROM tbl_opd_category');
                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal" method="post" action="opd_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="opd_name" name="opd_name" placeholder="Name">
                                        </div>
                                    </div>	
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="day1" name="day1" placeholder="Day 1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="time1" name="time1" placeholder="Time 1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="day2" name="day2" placeholder="Day 2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="time2" name="time2" placeholder="Time 2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" name="addOPD" id="addOPD" class="btn btn-success">Add</button>
