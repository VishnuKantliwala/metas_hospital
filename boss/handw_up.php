...
$handw_id=$_GET['handw_id'];

$query = $con->selectdb('SELECT * FROM tbl_handw_category');
...
$sqlC=$con->selectdb("SELECT cat_id FROM tbl_handw where handw_id=".$handw_id."");
                ...
                function generate_menu($parent)
                {
                        ...
                        foreach($menuItems as $key => $value)
                        {
                            ...
                            {    
                                ...
                                {
                                    echo '<li data-jstree='.'{"opened":true}'.'><a href="handwcategory.php?id=' . $key . '">' . $value['cat_name'] . '<b class="caret"></b></a>';
                                }
                                else if($value['cat_parent_id'] != 0 && in_array($key, $parentMenuIds))
                                {
                                    echo '<li data-jstree='.'{"opened":true}'.'><a href="handwcategory.php?id=' . $key . '">' . $value['cat_name'] . '</a>';
                                }
                                else
                                {
    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li>
                    <h4 class="page-title-main">Health and wellness</h4>
                </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                <h4 class="mt-0 header-title">Health and wellness Form</h4>
                                <form class="form-horizontal" method="post" action="handw_upload.php" id="myform" name="myform" enctype="multipart/form-data">
                                    ...
                                    {
                                    ?>
                                    <input type="hidden" name="handw_id" id="handw_id" value="<?php echo $row[0]; ?>" />	
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="handw_title" name="handw_title" placeholder="Name" value="<? echo $row[2];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="file" id="frontimg" name="frontimg" class="dropify" data-default-file="<? if($row[1]!=''){echo "../handw/".$row[1];}?>"/>
                                            <? if($row[1]!=''){?>
                                                <a href="handw_upload.php?id=<?php echo $row[0]; ?>&ProImage=Del" class="btn btn-lighten-danger" onClick="return confirm('Are you sure want to delete?');">Delete</a>
                                            <? } ?>
                                                                ...
                                                                <li class="list-inline-item file-box">
                                                                    <div class=" custom-control custom-switch">
                                                                        ...
                                                                        <label class="custom-control-label" for="<?php echo $image_list[$i]; ?>">
                                                                            <img src="../handwF/<?php echo $image_list[$i]; ?>" class="img-fluid img-thumbnail" alt="attached-img" width="80">
                                                                        </label>
                                                                    </div>
                                                                </li>
                                                    <?php
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-12">
                                            ...
                                            <button type="submit" name="myButton" id="myButton" class="btn btn-lighten-danger" onClick="window.location.href='handwView.php'; return false;" >Cancel</button>
                                        </div>
                                    </div>
