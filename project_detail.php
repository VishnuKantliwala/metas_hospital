        ...
        <div class="row">
            ...
            <div class="col-md-8 col-sm-8">
                ...
                <div class="single_blog_contents reveal animated" data-reveal-anim="fadeInUpShort">
                    ...
                    <hr>
                    <a href="javascript:void(0);" class="btn arrow_btn btn_messaging"><span class="btn-text"
                            data-hover="Donate">Donate</span> <span
                            class="icofont icofont-paper-plane btn_icon"></span></a>
                    <hr>
                </div>
            </div>
                        ...
                        <ul>
                            ...
                            <li><a href="<?echo $href?>">
                                    <span class="recent_blog_img v_middle">
                                        <img src="project/<?echo $project_image?>" alt="<?echo $project_name ?>"
                                            style="" class="blog_img--suggetions">
                                    </span>
                ...
                <div class="widget reveal animated" data-reveal-anim="fadeInRight">
                    ...
                    <div class="recent_posts">
                        ...
                        <form id="contactForm" class="message_form">
                            ...
                            <textarea cols="30" rows="2" placeholder="Message" name="contact_message"
                                required></textarea>
                            ...
                            <button type="submit" class="btn arrow_btn btn_messaging btn_submit_contact"><span
