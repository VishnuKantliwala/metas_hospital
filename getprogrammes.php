    ...
    <div class="row " style="background: #eee; padding:10px">
        ...
        <div class="col-md-12 col-xs-12 col-sm-6">
            <div class="blog_image pt-10" style="    margin-bottom: 10px;">
                <img class="programme-img bb-3" src="programme/big_img/<?echo $image_name?>" alt="<?echo $programme_title?>" style="   border-radius:  30px 0px ;">
            </div>
        ...
        <div class="col-md-12 col-xs-12 col-sm-6 blog_post">
            ...
            <p class="blog_text list-desc list-desc--programme" style="border-top: 1px solid #473516;margin-top:10px">  
